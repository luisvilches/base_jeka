...
<template>
    ...
    <div class="heading cf">
        <h1>Mi canasta de compra</h1>
        <a href="#" class="continue">Continuar comprando</a>
    </div>
  <div class="cart">
<ul class="tableHead">
      <li class="prodHeader">Producto</li>
      <li>Cantidad</li>
      <li>Total</li>
       <li>Quitar</li>
    </ul>
  ...
  <div class="promoCode"><label for="promo">¿Tienes un codigo de descuento?</label><input type="text" name="promo" placholder="Enter Code" />
  ...
  <div class="subtotal cf">
    <ul>
      <li class="totalRow"><span class="label">Subtotal</span><span class="value">$35.00</span></li>
          ...
          <li class="totalRow"><span class="label">Envio</span><span class="value">$5.00</span></li>
      
            <li class="totalRow"><span class="label">IVA</span><span class="value">$4.00</span></li>
